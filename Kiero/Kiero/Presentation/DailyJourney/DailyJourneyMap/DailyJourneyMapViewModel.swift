...
final class DailyJourneyMapViewModel: BaseViewModel, ViewModelType, ObservableObject {
    ...
    private let dailyJourneyMapService: DailyJourneyMapServiceType
    ...
    init(
        dailyJourneyMapService: DailyJourneyMapServiceType,
        dailyJourneyService: DailyJourneyServiceType
    ) {
        self.dailyJourneyMapService = dailyJourneyMapService
    ...
    private func fetchJourneyList() {
        Publishers.Zip(
            dailyJourneyMapService.fetchJourneyList(),
